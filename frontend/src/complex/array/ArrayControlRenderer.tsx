...
export const ArrayControl = ({
  ...
  const validationClass =
    getStyleAsClassName?.("array.control.validation") || "";
  const divClassNames = [validationClass]
    .concat(
      isValid
        ? ""
        : getStyleAsClassName?.("array.control.validation.error") || ""
    )
    .join(" ");
  const buttonClassAdd = getStyleAsClassName?.("array.control.add") || "";
  const labelClass = getStyleAsClassName?.("array.control.label") || "";
  const childControlsClass =
    getStyleAsClassName?.("array.child.controls") || "";
  const buttonClassUp = getStyleAsClassName?.("array.child.controls.up") || "";
  const buttonClassDown =
    getStyleAsClassName?.("array.child.controls.down") || "";
  const buttonClassDelete =
    getStyleAsClassName?.("array.child.controls.delete") || "";
  const controlClass = [
